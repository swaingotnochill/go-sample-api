...
func (_m *BookRepository) DeleteBook(c context.Context, id string) error {
	ret := _m.Called(c, id)
...
func (_m *BookRepository) GetBooks(c context.Context) ([]*domain.Book, error) {
	ret := _m.Called(c)
...
func (_m *BookRepository) GetBooksByID(c context.Context, id string) (*domain.Book, error) {
	ret := _m.Called(c, id)
...
func (_m *BookRepository) SaveBook(c context.Context, book *domain.Book) error {
